...
Although it might seem easy, done properly is not an easy as there are some challenges to address that was not in a monolith architecture.
...
{{< speaker initials="AS" >}}
**Alex Sotov** is a Director of Developer Experience at Red Hat.
