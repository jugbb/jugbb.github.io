...
event_type: talk
event_date: 2019-11-07T18:30:00+02:00
event_start: 2019-11-07T19:00:00+02:00
event_host: Smava
event_lang: en
event_speaker:
  - Alex Soto
...
Am **Donnerstag, dem 7. November 2019**, lädt die Java User Group Berlin-Brandenburg zum Vortrag **Kubernetes-Native Java with Quarkus** mit [Alex Soto](https://twitter.com/alexsotob?lang=de) ein.
<!--more-->

## Der Vortrag

**Kubernetes-Native Java with Quarkus** (_Alex Soto_)
...
Before this change, we just developed a monolith application where everything was up and running up front, now we are breaking down this monolith into (micro)services architecture and everything is interconnected with the network.
Although it might seem easy, done properly is not as easy as there are some challenges to address that were not present in a monolith architecture.
...
{{< speaker initials="AS" >}}
**Alex Soto** is a Director of Developer Experience at Red Hat.
He is passionate about Java world, software automation and he believes in the open-source software model.

He is also the creator of NoSQLUnit project, member of JSR374 (Java API for JSON Processing) Expert Group, the co-author of Testing Java Microservices book for Manning and contributor of several open-source projects.
